"""
Deutsch-Jozsa Benchmark Program - Fire Opal
"""
...
def balanced_oracle (input_size, num_qubits):
    ...
    # permit input_string up to 20 chars
    b_str = "10101010101010101010"
...
def analyze_and_print_result (qc, result, num_qubits, type):
    ...
    if verbose: 
        print("For type {type} measured: {counts}")
...
def run (
    ...
    print("Deutsch-Jozsa Benchmark Program - Fire Opal")
