...
<p align="center">
<img align=center src="../../doc/docs/images/quantum_fourier_transform/QFT_circ.png"  width="900" />
</p>
...
<p align="center">
<img align=center src="../../doc/docs/images/quantum_fourier_transform/QFT_circ_5.png"  width="900" />
</p>
...
- **Method 1**: Initialize inputs to a classical value <img align=center src="https://latex.codecogs.com/svg.latex?\small\pagecolor{white}x">, perform QFT, rotate the qubits to increase <img align=center src="https://latex.codecogs.com/svg.latex?\small\pagecolor{white}x"> by 1 in the Fourier basis
   ...
   <p align="center">
   <img align=center src="../../doc/docs/images/quantum_fourier_transform/QFT1_circ.png"  width="800" />
   </p>
...
- **Method 2** Initialize inputs to represent the result of a QFT on a classical value followed by the inverse QFT to retrieve
   ...
   <p align="center">
   <img align=center src="../../doc/docs/images/quantum_fourier_transform/QFT2_circ.png"  width="600" />
   </p>
...
- **Method 3** Initialize the inputs to a quantum superposition, perform an inverse QFT, and 
   ...
   <p align="center">
   <img align=center src="../../doc/docs/images/quantum_fourier_transform/QFT3_circ.png"  width="600" />
   </p>
