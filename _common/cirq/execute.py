...
def transpile_for_metrics(qc):
    ...
    gateset = cirq.CZTargetGateset(allow_partial_czs=True)    # help(cirq.CZTargetGateset) ---> to check the gateset
    ...
    # # cirq.testing.assert_circuits_with_terminal_measurements_are_equivalent(qc, optimized_circuit)    # Error: optimized circuit and original circuit got differ
