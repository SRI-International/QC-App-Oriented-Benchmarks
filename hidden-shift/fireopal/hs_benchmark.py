"""
Hidden Shift Benchmark Program - Fire Opal
"""
...
def run(
    ...
    print("Hidden Shift Benchmark Program - Fire Opal")
    ...
    def execution_handler(qc, result, num_qubits, s_int):
        ...
        _, fidelity = analyze_and_print_result(
            qc, result, num_qubits, int(s_int)
        )
    ...
    for num_qubits in range(min_qubits, max_qubits + 1, 2):
        ...
        for s_int in s_range:
            ...
            # collapse the sub-circuit levels used in this benchmark
            qc2 = qc.decompose()
    ...
    print("\nQuantum Oracle 'Ug' =")
    print(Ug_ if Ug_ != None else " ... too large!")

    # Plot metrics for all circuit sizes
    metrics.plot_metrics("Benchmark Results - Hidden Shift - Fire Opal")
