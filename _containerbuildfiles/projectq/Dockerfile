...
COPY ${BROOT}/benchmarks-projectq.ipynb.template/ ${PROJECT_DIR}/benchmarks-projectq.ipynb
COPY ${BROOT}/_common/metrics.py ${PROJECT_DIR}/

EXPOSE 8887
CMD ["jupyter", "notebook", "--port=8887", "--ip=0.0.0.0", "--no-browser", "--allow-root"]